...
```{r}
if (!file.exists("sakila.sqlite")) {
  download.file("https://github.com/UCDavis-STA-141B-Winter-2020/sta141b-lectures/raw/master/02-11/sakila.sqlite", destfile = "sakila.sqlite")
}
```
...
I have also uploaded the Sakila database to a postgres server owned by the department. (You'll need to either on the campus or over vpn to connect to it)
